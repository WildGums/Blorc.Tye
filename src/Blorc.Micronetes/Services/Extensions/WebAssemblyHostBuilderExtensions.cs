namespace Blorc.Services.Extensions
{
    using System;
    ...
    public static class WebAssemblyHostBuilderExtensions
    {
        ...
        /// The <see cref="Task"/>.
        /// </returns>
        public static async Task<bool> IsMicronetesConfigurationAvailable(this WebAssemblyHostBuilder @this)
        {
            ...
            var section = await configurationService.GetSection<Micronetes>("micronetes");
